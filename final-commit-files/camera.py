...
class VideoCamera_hindi(object):
    ...
    def __init__(self):
        ...
        self.font_path = 'C:/Users/sange/AppData/Local/Microsoft/Windows/Fonts/TiroDevanagariHindi-Italic.ttf'
    ...
    def get_frame(self):
        ...
        # Load the Tamil font
        font = ImageFont.truetype(self.font_path, 30)  # Adjust the font size as needed

        # Render the Tamil text on the image
        text_position = (10, 50)  # Adjust the text position as needed
        text_color = (139, 0, 0)  # Adjust the text color as needed
...
class VideoCamera_tamil(object):
    ...
    def __init__(self):
        ...
        # Specify the font file path for Tamil
        self.font_path = 'C:/Users/sange/AppData/Local/Microsoft/Windows/Fonts/NotoSansTamil-VariableFont_wdth,wght.ttf'
    ...
    def get_frame(self):
        ...
        # Render the Tamil text on the image
        text_position = (10, 50)  # Adjust the text position as needed
        text_color = (0,0,0) # Adjust the text color as needed
        draw.text(text_position, output_text, font=font, fill=text_color)
